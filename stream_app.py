...
def main():
    ...
    st.markdown(
        '<h6>Made in &nbsp<img src="https://streamlit.io/images/brand/streamlit-mark-color.png" alt="Streamlit logo" height="16">&nbsp by <a href="https://github.com/Rakshitha-Sargurunathan/customer-churnapp-streamlit "> Rakshitha V S</a></h6>',
            unsafe_allow_html=True,
        )
    

    #option = st.sidebar.selectbox("Select option", [" ","Predict Churn", "Visualize Charts", "Display Dataset"])
    option = st.sidebar.radio("CONTENTS", ["Home","Predict Churn", "Visualize Charts","Upload & Predict", "Display Dataset"])
    st.sidebar.info("This web app is created to predict Customer Churn")
    if option == "Home":
        st.write("""
    ...
    **How to use?**
    ...
    if option == "Predict Churn":
        ...
        if file_upload is not None:
            ...
            X_dicts = data.to_dict(orient='records')  # Convert DataFrame to a list of dictionaries
